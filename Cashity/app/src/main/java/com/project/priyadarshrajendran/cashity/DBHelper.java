...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "Cashity.db";
    ...
    public int deleteAddExpense(String id){

        SQLiteDatabase db = this.getWritableDatabase();
        return db.delete(EXPENSE_TABLE_NAME,"id = ?",new String[] {id});
